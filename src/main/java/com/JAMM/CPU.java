           ...
           System.out.print("Which cache information would you like to know about? 1, 2, 3: ");
            option = ise.nextInt();
             ...
             switch (option) {
              ...
              case 2:    
                 int limit2 = c2; // limit is number of level 2 caches          
                 c2 = size - (c1 + c2);
                 int start2 = 0; 
                  ...
                  while (start2 < limit2) {
                     ...
                     System.out.println("Cache Size: " + ((List<ProcessorCache>) caches).get(c2).getCacheSize() + " bytes"); 
                       start2++; // increases until all level 2 caches are printed
                       c2++;   
                        } 
                        break;
              ...
              case 3:              
                 int limit3 = c3;
                 c3 = size - (c1 + c2 + c3); // should equal to 0 which will be this index pf the first cache: L3
